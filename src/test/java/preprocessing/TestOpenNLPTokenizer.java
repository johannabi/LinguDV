...
public class TestOpenNLPTokenizer {
	...
	public void test() {
		...
		String correct = "[Bis, ins, Mittelalter, wurde, der, Bergbau, nur, in, geringem, Umfang, ausgeübt, ., Es, gab, relativ, wenig, Bergwerke, ,, die, den, jeweiligen, Landesherrn, unterstanden, .]";
